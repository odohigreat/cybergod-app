function HeroButton() {
  return (
    ...
    >
      Get Started
      <svg
        className="w-8 h-8 justify-end group-hover:rotate-90 group-hover:bg-gray-50 text-gray-50 ease-linear duration-300 rounded-full border border-gray-700 dark:border-gray-200 group-hover:border-none p-2 rotate-45"
        viewBox="0 0 16 19"
