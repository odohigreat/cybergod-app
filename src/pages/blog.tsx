            ...
            <article className="relative isolate flex flex-col gap-8 lg:flex-row">
              ...
              <div>
                <div className="flex items-center gap-x-4 text-xs">
                  ...
                  <span className="relative z-10 rounded-lg bg-green-500 px-3 py-1 font-medium text-neutral-50 hover:brightness-110">New</span>
                </div>
                <div className="group relative max-w-xl">
                  <h3 className="mt-3 text-lg/6 font-semibold text-gray-900 dark:text-white group-hover:text-gray-600 dark:group-hover:text-gray-300">
                    <button type="button" className="text-left w-full relative">
                  ...
                  <div className="relative flex items-center gap-x-4">
                    ...
                    <div className="text-sm/6">
                      <p className="font-semibold text-gray-900 dark:text-white">
                        <button type="button" className="text-left relative">
                          <span className="absolute inset-0"></span>
                          Great Odohi
                        </button>
                      </p>
